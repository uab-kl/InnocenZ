...
const styles = StyleSheet.create({
  ...
  metresText: { ...font(700), fontSize: 13, color: C.amber },
  refreshGps: {
    ...font(),
    fontSize: 12,
    color: C.blue,
  ...
  onDutyLabel: { ...font(), fontSize: 13, color: C.muted },
  onDutyAmt: { ...font(800), fontSize: 18, color: C.accentL },
  completeHero: {
    marginTop: 14,
    padding: 14,
    borderRadius: 14,
  ...
  sheetMeta: { marginTop: 6, ...font(), fontSize: 13, color: C.prMuted },
  sheetHint: { marginTop: 8, ...font(), fontSize: 13, color: C.prMuted2, lineHeight: 18 },
  rulesTitle: {
    marginTop: 14,
    ...font(700),
    fontSize: 12,
  ...
  ruleLabel: { ...font(), fontSize: 13, color: C.prMuted },
  ruleOutcome: { ...font(700), fontSize: 13 },
  fieldLabel: {
    marginTop: 12,
    marginBottom: 4,
    ...font(600),
  ...
  locCheckText: { ...font(), fontSize: 13, color: C.txt, lineHeight: 18 },
  locEnableBtn: {
    alignSelf: 'stretch',
    marginTop: 16,
    borderRadius: 14,
  ...
  locEnableText: { ...font(800), fontSize: 15, color: '#241a08' },
});
