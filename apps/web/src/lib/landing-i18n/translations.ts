...
export const translations: Record<LandingLocale, LandingTranslations> = {
	en: {
		...
		hero: {
			...
			titleLine1: "The Operating Platform",
		...
		challenges: {
			...
			sub: "Every outlet, every agency, every PR — losing time and money to the same broken loop. Roster in WhatsApp. Payroll in Excel. Disputes in cash.",
			forLabel: "For",
			outletOwners: "Outlet",
		...
		solution: {
			...
			outletLabel: "Outlet",
			outletDesc: "Books tonight & watches the floor",
			agencyLabel: "PR Agency",
			agencyDesc: "Rosters, matches, reconciles",
			prLabel: "PR",
			prDesc: "Checks in, scans, signs, gets paid",
	...
	zh: {
		...
		challenges: {
			...
			sub: "每家门店、每个代理、每位 PR——都在同一个断裂循环中浪费时间与金钱。排班在 WhatsApp，薪资在 Excel，争议靠现金。",
			forLabel: "面向",
			outletOwners: "门店",
			prAgencies: "PR 代理",
			prProfessionals: "PR",
